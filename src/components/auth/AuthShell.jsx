  ...
  return (
    <div className="hidden lg:block flex-1 relative rounded-[28px] overflow-hidden isolate">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(140deg, #2d040a 0%, #5a0815 38%, #250508 72%, #110204 100%)",
        }}
      />
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(255,77,106,0.55) 0%, transparent 70%)",
          filter: "blur(60px)",
        }}
        animate={{
          x: [0, 40, 0],
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(200,16,46,0.6) 0%, transparent 70%)",
          filter: "blur(60px)",
        }}
        animate={{
          x: [0, -30, 0],
...
export function AuthPrimaryButton({ children, disabled, ...props }) {
  return (
    <motion.button
      ...
      disabled={disabled}
      className="relative w-full h-12 rounded-2xl text-white font-semibold text-[15px] flex items-center justify-center gap-2 overflow-hidden shadow-[0_8px_24px_-8px_rgba(200,16,46,0.55)] transition-all duration-200 hover:shadow-[0_12px_28px_-8px_rgba(200,16,46,0.7)] disabled:opacity-60 disabled:cursor-not-allowed"
      style={{
        background:
          "linear-gradient(135deg, #c8102e 0%, #9e0c24 50%, #5a0815 100%)",
      }}
      {...props}
    >
      {/* Soft sheen on top */}
