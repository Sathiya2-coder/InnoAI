      ...
      <DarkPanel className="px-6 sm:px-12 lg:px-20 py-16 sm:py-24 text-center">
        ...
        >
          ...
          <span
            style={{
              backgroundImage:
                "linear-gradient(120deg, #ff4d6a 0%, #c8102e 50%, #9e0c24 100%)",
        ...
        >
          Bring your ideas to life now. Discover insights, build solutions, and
        ...
        >
          <Link
            to="/register"
            className="group relative inline-flex items-center gap-2 h-12 px-6 rounded-full font-semibold text-[14px] text-white shadow-[0_10px_30px_-8px_rgba(200,16,46,0.5)] hover:shadow-[0_14px_36px_-8px_rgba(200,16,46,0.7)] active:scale-[0.98] transition-all"
            style={{
              background:
          ...
          >
            ...
            />
            <span className="relative">Start Innovating Now</span>
        ...
        >
          ...
          No credit card · Your data stays private and secure
        </motion.div>
      </DarkPanel>
    </section>
  );
