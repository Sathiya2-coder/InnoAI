...
export function HeroDashboardPreview() {
  return (
    <div className="relative w-full h-[460px] sm:h-[520px]">
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <div className="text-[11px] text-white/55 mt-0.5">Smart_Campus_Nav.proj</div>
          </div>
          <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[rgba(200,16,46,0.14)] text-[#c8102e] text-[10px] font-semibold">
        ...
        <div className="mt-3 flex items-center justify-center">
          <div className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-[rgba(200,16,46,0.16)] text-[#ff4d6a] text-[10px] font-semibold tabular">
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="h-6 w-6 rounded-lg bg-[rgba(200,16,46,0.16)] text-[#ff4d6a] flex items-center justify-center">
            <Sparkles size={12} />
          </div>
          <div className="text-[11px] font-semibold text-white">AI rewrite</div>
          <div className="ml-auto inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-[rgba(200,16,46,0.16)] text-[#ff4d6a] text-[9px] font-semibold">
        ...
        <div className="flex items-center gap-1.5 my-2 text-white/30">
          <ArrowRight size={11} />
          <span className="text-[9px] uppercase tracking-wide text-[#ff4d6a] font-semibold">
            After
          </span>
        </div>
