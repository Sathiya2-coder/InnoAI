...
const FEATURES = [
  {
    ...
    desc: "AI-powered feasibility and impact scoring to validate your ideas before you build.",
  ...
  },
  {
    ...
    desc: "Generate creative solutions in your domain, with actionable insights — not generic fluff.",
    preview: <RewritePreview />,
  },
  {
    icon: KeyRound,
    title: "Smart Research",
    desc: "Auto-analyzes market trends and competition, surfaces gaps and opportunities.",
    preview: <KeywordsPreview />,
  },
  {
    icon: Layers,
    title: "Project Versioning",
    desc: "Every iteration tracked, scored, and one click away.",
    preview: <VersionsPreview />,
  },
  {
    icon: GitCompare,
    title: "Idea Comparison",
    desc: "Compare different approaches side by side — feature by feature.",
    preview: <DiffPreview />,
  },
  {
    icon: LineChart,
    title: "Analytics Dashboard",
    desc: "Track innovation progress, ideas generated, and project milestones over time.",
  ...
  },
  {
    ...
    desc: "Export complete project blueprints with tech stack, roadmap, and architecture.",
    preview: <PdfPreview />,
  },
];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(200,16,46,0.18) 0%, rgba(200,16,46,0.06) 35%, transparent 70%)",
          filter: "blur(60px)",
        }}
      />
      ...
      <SectionHeader
        ...
        title={
          <>
            Everything your innovation
            <br className="hidden sm:block" /> needs to{" "}
            <span
              style={{
                backgroundImage:
                  "linear-gradient(120deg, #9e0c24 0%, #5a0815 60%, #9e0c24 100%)",
        ...
        {FEATURES.map((f, i) => (
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent, rgba(158,12,36,0.25), transparent)",
              }}
            />
